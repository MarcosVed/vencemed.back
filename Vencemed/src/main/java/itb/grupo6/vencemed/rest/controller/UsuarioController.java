...
public class UsuarioController {
	...
	public ResponseEntity<Optional<Usuario>> login(@RequestBody Usuario usuario) {
		...
		Optional<Usuario> _usuario = usuarioService.login(usuario.getEmail(), usuario.getSenha());
	...
	public ResponseEntity<?> alterarNivel(@PathVariable long adminId, @PathVariable long usuarioId,
